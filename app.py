...
def predict():
    ...
    model_features = model.feature_names_in_  # This gets the feature names the model was trained on
    ...
    for col in model_features:
        if col not in new_df__dummies.columns:
            new_df__dummies[col] = 0

    # Ensure the order of columns matches the model features
    new_df__dummies = new_df__dummies[model_features]
